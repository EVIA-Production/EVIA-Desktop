...
const DURING_ACTIONS: InsightActionItem[] = [
  ...
  {
    label: '✨ Reframe the objection',
    icon: 'sparkle',
    prompt: 'Reframe the objection',
  },
  {
    label: '❓ Surface cost of inaction',
    icon: 'question',
    prompt: 'Surface the cost of inaction',
  },
]
...
export const DEMO_PREP_PROMPT = 'Prepare me for my call with Anista.'
